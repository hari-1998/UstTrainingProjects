...
import com.company.vendors.services.VendorService;
import com.company.vendors.utilities.EmailUtility;
import com.company.vendors.utilities.ReportUtility;
...
public class VendorController {
	...
	@Autowired
	EmailUtility emailUtiltiy;
	
	@Autowired
	ServletContext sc;
	
	@Autowired
	ReportUtility reportUtil;
	...
	public String saveVendor(@ModelAttribute("vendor") Vendor vendor,ModelMap modelMap) {
		...
		emailUtiltiy.sendEmail("harikrishnant1998@gmail.com", "New Vendor Added", vendors.toString());
		return "createVendor";
	}
